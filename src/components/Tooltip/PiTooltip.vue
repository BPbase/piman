  ...
  >
    ...
    <div
      ...
      :class="[
        ...
        `pi-tooltip__container--${arrowsPosition}`
      ]"
      @mouseover="open"
      @mouseout="close"
    >
...
const open = () => {
  ...
  } else if(tooltip.right + (box.offsetWidth / 2) > document.documentElement.clientWidth || props.arrowPlacement === 'rl'){
    box.style.right = `${document.documentElement.clientWidth - tooltip.right}px`;
    box.style.left = 'inherit'
    arrowsPosition.value = 'rl';
  } else {
